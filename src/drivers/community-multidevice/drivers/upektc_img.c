...
static const struct usb_id upektc_img_id_table[] = {
	{ .idVendor = 0x147e, .idProduct = 0x2020, .description = "", },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = UPEKTC_IMG_NAME;
	dev->full_name = "Upek TouchChip Fingerprint Coprocessor";
	...
	dev->usb_info.id_table = upektc_img_id_table;
	...
	priv->community_driver_id = UPEKTC_IMG_NAME;
