...
static const struct usb_id upeke2_id_table[] = {
	{ .idVendor = 0x147e, .idProduct = 0x2016, .description = "UPEK Eikon 2" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = UPEKE2_NAME;
	dev->full_name = "UPEK Eikon 2";
	...
	dev->usb_info.id_table = upeke2_id_table;
	...
	cfpdev->dev = NULL;
	cfpdev->community_driver_id = UPEKE2_ID;
