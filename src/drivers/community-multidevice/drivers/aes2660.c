...
static const struct usb_id aes2660_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x2660, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2680, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2681, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2682, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2683, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2684, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2685, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2686, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2687, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2688, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2689, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268a, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268b, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268c, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268d, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268e, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x268f, .description = "" },
	{ .idVendor = 0x08ff, .idProduct = 0x2691, .description = "" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = AES2660_NAME;
	dev->full_name = "AuthenTec AES2660";
	...
	dev->usb_info.id_table = aes2660_id_table;
	...
	priv->community_driver_id = AES2660_NAME;
