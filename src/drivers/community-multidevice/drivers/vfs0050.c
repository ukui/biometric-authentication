...
static const struct usb_id vfs0050_id_table[] = {
	{ .idVendor = 0x138a, .idProduct = 0x0050, .description = "" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = VFS0050_NAME;
	dev->full_name = "Validity VFS0050";
	...
	dev->usb_info.id_table = vfs0050_id_table;
	...
	priv->community_driver_id = VFS0050_NAME;
