...
static const struct usb_id vfs101_id_table[] = {
	{ .idVendor = 0x138a, .idProduct = 0x0001, .description = "" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = VFS101_NAME;
	dev->full_name = "Validity VFS101";
	...
	dev->usb_info.id_table = vfs101_id_table;
	...
	priv->community_driver_id = VFS101_NAME;
