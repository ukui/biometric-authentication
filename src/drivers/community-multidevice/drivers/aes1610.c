...
static const struct usb_id aes1610_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x1600, .description = "AuthenTec AES1610" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = AES1610_NAME;
	dev->full_name = "AuthenTec AES1610";
	...
	dev->usb_info.id_table = aes1610_id_table;
	...
	priv->community_driver_id = AES1610_NAME;
