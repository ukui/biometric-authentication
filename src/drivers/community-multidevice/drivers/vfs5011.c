...
static const struct usb_id vfs5011_id_table[] = {
	{ .idVendor = 0x138a, .idProduct = 0x0010, .description = "Validity device from some Toshiba laptops" },
	{ .idVendor = 0x138a, .idProduct = 0x0011, .description = "vfs5011" },
	{ .idVendor = 0x138a, .idProduct = 0x0017, .description = "Validity device from Lenovo T440 laptops" },
	{ .idVendor = 0x138a, .idProduct = 0x0018, .description = "one more Validity device" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = VFS5011_NAME;
	dev->full_name = "Validity VFS5011";
	...
	dev->usb_info.id_table = vfs5011_id_table;
	...
	priv->community_driver_id = VFS5011_NAME;
