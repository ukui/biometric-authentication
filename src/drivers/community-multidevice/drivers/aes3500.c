...
static const struct usb_id aes3500_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x5731, .description = "AuthenTec AES3500" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = AES3500_NAME;
	dev->full_name = "AuthenTec AES3500";
	...
	dev->usb_info.id_table = aes3500_id_table;
	...
	priv->community_driver_id = AES3500_NAME;
