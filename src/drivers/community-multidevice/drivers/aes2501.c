...
static const struct usb_id aes2501_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x2500, .description = "AES2500" },
	{ .idVendor = 0x08ff, .idProduct = 0x2580, .description = "AES2501" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = AES2501_NAME;
	dev->full_name = "AuthenTec AES2501/AES2500";
	...
	dev->usb_info.id_table = aes2501_id_table;
	...
	priv->community_driver_id = AES2501_NAME;
