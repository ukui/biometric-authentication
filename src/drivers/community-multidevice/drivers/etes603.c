...
static const struct usb_id etes603_id_table[] = {
	{ .idVendor = 0x1c7a, .idProduct = 0x0603, .description = "EgisTec (aka Lightuning) ES603"},
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = ETES603_NAME;
	dev->full_name = "EgisTec (aka Lightuning) ES603";
	...
	dev->usb_info.id_table = etes603_id_table;
	...
	priv->community_driver_id = ETES603_NAME;
