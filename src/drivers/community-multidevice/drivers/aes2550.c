...
static const struct usb_id aes2550_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x2550, .description = "AES2550" },
	{ .idVendor = 0x08ff, .idProduct = 0x2810, .description = "AES2810" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = AES2550_NAME;
	dev->full_name = "AuthenTec AES2550/AES2810";
	...
	dev->usb_info.id_table = aes2550_id_table;
	...
	priv->community_driver_id = AES2550_NAME;
