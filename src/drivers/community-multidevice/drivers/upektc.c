...
static const struct usb_id upektc_id_table[] = {
	{ .idVendor = 0x0483, .idProduct = 0x2015, .description = "UPEKTC_2015" },
	{ .idVendor = 0x147e, .idProduct = 0x3001, .description = "UPEKTC_3001" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = UPEKTC_NAME;
	dev->full_name = "UPEK TouchChip/Eikon Touch 300";
	...
	dev->usb_info.id_table = upektc_id_table;
	...
	priv->community_driver_id = UPEKTC_NAME;
