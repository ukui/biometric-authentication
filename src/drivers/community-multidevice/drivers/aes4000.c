...
static const struct usb_id aes4000_id_table[] = {
	{ .idVendor = 0x08ff, .idProduct = 0x5501, .description = "AuthenTec AES4000" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->usb_info.id_table = aes4000_id_table;
	...
	priv->community_driver_id = AES4000_NAME;
