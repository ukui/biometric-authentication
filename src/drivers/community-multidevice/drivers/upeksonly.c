...
static const struct usb_id upeksonly_id_table[] = {
	{ .idVendor = 0x147e, .idProduct = 0x1000, .description = "UPEKSONLY_1000" },
	{ .idVendor = 0x147e, .idProduct = 0x1001, .description = "UPEKSONLY_1001" },
	{ 0, 0, NULL },
};
...
int ops_configure(bio_dev * dev, GKeyFile * conf)
{
	...
	dev->device_name = UPEKSONLY_NAME;
	dev->full_name = "UPEK TouchStrip Sensor-Only";
	...
	dev->usb_info.id_table = upeksonly_id_table;
	...
	priv->community_driver_id = UPEKSONLY_NAME;
