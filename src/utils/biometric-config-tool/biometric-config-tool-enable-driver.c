...
GOptionEntry enable_driver_entries[] = {
...
gboolean
biometric_config_enable_driver (int argc, char **argv, GError **error)
{
	int i = 0;

	GOptionContext *context;
	context = g_option_context_new (_("Driver1 [Driver2 ...]"));
	g_option_context_add_main_entries (context, enable_driver_entries, NULL);
